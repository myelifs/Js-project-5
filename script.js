...
let siparis1_toplam = (siparis_1.urunler[0].urun_fiyati + siparis_1.urunler[1].urun_fiyati) * 1.18;
let siparis2_toplam = (siparis_2.urunler[0].urun_fiyati) * 1.18;
...
console.log("toplam ödenen tutar: " + toplam_siparis);
